...
<body id="mainframe">
	...
	<form id="orderForm" class="hide" action="/order/create.html"
		...
		<input type="hidden" name="orderShipping.receiverName" value="张超" />
		<input type="hidden" name="orderShipping.receiverMobile"
			value="15891588888" /> <input type="hidden"
			name="orderShipping.receiverState" value="江苏省" /> <input
			type="hidden" name="orderShipping.receiverCity" value="南京市" /> <input
			type="hidden" name="orderShipping.receiverDistrict" value="秦淮区" /> <input
			type="hidden" name="orderShipping.receiverAddress"
			value="xxx普天路1号B02栋4楼" />
	</form>
									...
									<ul class="ui-switchable-panel-main" id="consignee-list">
										...
										<li class="ui-switchable-panel" id="consignee_index_137617472"
											...
											<div class="consignee-item item-selected"
												...
												<div class="user-name">
													<div class="fl">
														<strong limit="4">张超</strong>&nbsp;&nbsp;收
													</div>
													<div class="fr">158****8888</div>
													<div class="clr"></div>
												</div>
												<div class="mt10" limit="15">江苏省 南京市 秦淮区 </div>
												<div class="adr-m" limit="30">xxx普天路1号B02栋4楼</div>
